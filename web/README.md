...
- Web: Vercel works out of the box (framework preset Next.js, root directory `web`). Set `NEXT_PUBLIC_API_URL` to the public API URL, for example `https://api.paperhood.xyz`. Do not set `NEXT_PUBLIC_DEV_AUTH` in production.
