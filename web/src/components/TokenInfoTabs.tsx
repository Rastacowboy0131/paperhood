        ...
        {tab === "trades" && (
          trades === null ? (
            ...
            <table className="num w-full min-w-[560px] text-xs">
              ...
              <tbody>
                {trades.map((t, i) => (
                  <tr key={`${t.txHash}-${i}`} className="border-b border-term-line transition-colors last:border-0 hover:bg-term-hover">
        ...
        {tab === "traders" && (
          topTraders === null ? (
            ...
            <table className="num w-full min-w-[560px] text-xs">
              ...
              <tbody>
                {topTraders.map((t, i) => (
                  <tr key={t.wallet} className="border-b border-term-line transition-colors last:border-0 hover:bg-term-hover">
        ...
        {tab === "holders" && (
          holders === null ? (
            ...
            <table className="num w-full min-w-[480px] text-xs">
              ...
              <tbody>
                {holders.map((h, i) => (
                  <tr key={h.address} className="border-b border-term-line transition-colors last:border-0 hover:bg-term-hover">
                    <td className={`${tdCls} text-term-dim`}>{i + 1}</td>
                    <td className={tdCls}>
        ...
        {tab === "paper" && (
          paper === null ? (
            ...
            <table className="num w-full min-w-[520px] text-xs">
              ...
              <tbody>
                {paper.map((t) => (
                  <tr key={t.id} className="border-b border-term-line transition-colors last:border-0 hover:bg-term-hover">
                    <td className={`${tdCls} text-term-dim`}>{timeAgo(t.ts)}</td>
